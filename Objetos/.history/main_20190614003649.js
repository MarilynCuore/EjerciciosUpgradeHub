...
class Client extends Person {
  ...
  buy(product, number){
     for(var p = 0; p > tienda.products.length; p++){
      if(product == tienda.products.name){
...
let tienda = {
   store: [
     new Store({name:'ZARA', opening:'9:00', close:'21:00', cash: 0})
   ],  
  products: [
 ...
 var cliente = new Client('Laura', 300);
cliente.buy('camiseta', 1)