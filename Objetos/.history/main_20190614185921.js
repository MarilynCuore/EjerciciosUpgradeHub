...
var tienda = zara = new Store({name:'ZARA', opening:'9:00', close:'21:00', cash: 0,}); 


tienda.zara.addProduct(new Product({name: 'camiseta', price: 10, stock: 20}));
tienda.zara.addProduct(new Product({name: 'pantalones', price: 15, stok: 10}));
tienda.zara.addProduct(new Product({name: 'falda', price: 20, stock: 0}));
tienda.zara.addProduct(new Product({name: 'zapatos', price: 30, stock: 30}));
tienda.zara.addProduct(new Product({name: 'camisas', price: 25, stock: 15 }));
